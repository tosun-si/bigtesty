...
def create_datasets_and_tables(datasets_with_tables_config: List[Dict],
                               datasets_hash: str,
...
def create_tables(dataset_config: Dict,
                  dataset: Dataset,
    ...
    for table_config in dataset_config["tables"]:
        (
            ...
            else get_table(dataset_id_with_hash, dataset, table_config)
        )
